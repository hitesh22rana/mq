...
const (
	BrokerService_CreateChannel_FullMethodName = "/event.BrokerService/CreateChannel"
	BrokerService_Publish_FullMethodName       = "/event.BrokerService/Publish"
	BrokerService_Subscribe_FullMethodName     = "/event.BrokerService/Subscribe"
)
...
var BrokerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "event.BrokerService",
